...
@NgModule({
  imports: [JhipsterDialogApplicationSharedModule, RouterModule.forChild(conditionDefinitionRoute)],
  declarations: [
...
export class JhipsterDialogApplicationConditionDefinitionModule {}
